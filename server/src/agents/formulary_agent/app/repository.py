                ...
                self.records.append(
                    {
                        ...
                        "patient_coinsurance": parse_float(row.get("patient_coinsurance")),
                        "estimated_patient_cost": parse_float(row.get("estimated_patient_cost")),
                        "prior_auth_required": parse_bool(row.get("prior_auth_required") or row.get("pa_required")),
                        "step_therapy_required": parse_bool(row.get("step_therapy_required")),
